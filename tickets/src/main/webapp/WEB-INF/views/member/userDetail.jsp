		...
		<div class="mx-auto">
			...
			<div class="form-group" id="memberId-container">
			  ...
			  <input type="text" class="form-control" id="memberId" name="memberId" 
			  		 value="${loginMember.principal.memberId}" readonly>
			</div>
			...
			<div class="form-group">
			  ...
			  <input type="text" class="form-control" id="name" name="name" 
			  		 value="${loginMember.principal.name}" required>
			</div>
			<div class="form-group">
			  <label class="col-form-label" for="email">이메일</label>
			  <input type="email" class="form-control" id="email" name="email" 
			  		 value="${loginMember.principal.email}" required>
			</div>
			<div class="form-group">
			  <label class="col-form-label" for="phone">전화번호</label>
			  <input type="tel" class="form-control" id="phone" name="phone" 
			  		 value="${loginMember.principal.phone}" required>
			</div>
			<div class="form-group">
				...
				<div class="align-middle">
					<input class="form-control d-inline-block" style="width:40%;" type="text" id="sample4_postcode" name="postCode"
						   value="${loginMember.principal.postCode}" readonly>
				...
				<input class="form-control my-1" type="text" id="sample4_roadAddress" name="addr" 
					   value="${loginMember.principal.addr}" readonly>
			...
			<%-- <button type="button" 
						...
						onclick="memberWithdraw('<sec:authentication property="principal.username"/>')">회원 탈퇴</button> --%>
