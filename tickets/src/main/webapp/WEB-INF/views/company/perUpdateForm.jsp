	...
	<form id="performanceRegisterFrm" 
		...
		<div class="mx-auto">
		    ...
		    <%-- <div class="form-group">
		      ...
		      <input type="file" class="form-control-file" id="perImgFile" name="perImgFile" value="${ performance.perImgOriginalFileName }">		     
		    </div>
			
			<div class="form-group">
		      <label for="detailImgFile">작품설명 이미지</label>
		      <input type="file" class="form-control-file" id="detailImgFile" name="detailImgFile" value="${ performance.detailImgOriginalFileName }">		      
		    </div>  --%>
		    
		    <div class="form-group">
		      <label for="perRating">공연 관람 등급</label>
		      <select class="form-control" id="perRating" name="perRating" value="${ performance.perRating }" >
