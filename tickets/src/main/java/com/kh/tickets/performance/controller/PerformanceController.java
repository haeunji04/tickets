...
//										@RequestParam(value="memberId", required=false) String memberId,
			@RequestParam("category") String category, HttpServletRequest request) {
...
//		int offset = (cPage - 1) * limit;
	...
	@GetMapping("/search")
	public ModelAndView searchView(ModelAndView mav, @RequestParam("keyword") String keyword) {
	...
	public ModelAndView performanceRegister(Performance performance,
			...
			@RequestParam(value = "reservationStart") String rStartDate, HttpServletRequest request, ModelAndView mav) {
...
//	}
	...
	@GetMapping("/company/companyPerList.do")
	public ModelAndView companyPerList(ModelAndView mav, Principal principal) {
		log.debug("Principal = {}", principal);
	...
	public ModelAndView perUpdateForm(ModelAndView mav, @RequestParam int perNo,
...
//		log.debug("aloneSale@@ = {}", aloneSale);
	...
	public ModelAndView perDateUpdate(ModelAndView mav, @RequestParam int perNo) {
	...
	public ModelAndView deleteSchForm(ModelAndView mav, @RequestParam int perNo) {
		log.debug("perNo = {}", perNo);
...
//		redirectAttributes.addFlashAttribute("perNo", perNo);	
	...
	public ModelAndView performanceInfoView2(ModelAndView mav, @RequestParam int perNo, Principal principal) {
...
//		mav.addObject("loginMember", loginMember);		
	...
	public ModelAndView selectSeat(ModelAndView mav, @RequestParam int schNo, @RequestParam int perNo,
		...
		List<Selected> selectedList2 = performanceService.selectSelectedList(schNo);
		Selected[] arr = selectedList2.toArray(new Selected[selectedList2.size()]);
...
//			if (diffDay > 1) {
	...
	public ModelAndView salePerformance(ModelAndView mav, @RequestParam int[] seatNo, @RequestParam String[] seatName,
			@RequestParam int schNo, @RequestParam String memberId) {
	...
	public ModelAndView paySelect(ModelAndView mav, @RequestParam int[] seatNo, @RequestParam String[] seatName,
			@RequestParam int schNo, @RequestParam String memberId, @RequestParam int total,
			@RequestParam int originTotal, @RequestParam int sale) {
...
//	/performance/wishListView.do
	...
	public ModelAndView wishListView(ModelAndView mav, Principal principal) {
...
//	
	...
	public String adminRecommendedList(Model model, HttpServletRequest request) {
...
//	    }
	...
	public ModelAndView searchPerformance(ModelAndView mav, HttpServletRequest request,
